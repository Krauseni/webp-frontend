...
function impressum() {
  return (
    <div class='padding'>
      ...
      <p>Torsten Grunewald <br />
        Baumschulenstraße 1a<br />
        12437 Berlin <br />
      </p>
      <p> <strong>Vertreten durch: </strong><br />
        Torsten Grunewald<br />
      </p>
      <p><strong>Registereintrag: </strong><br />
        Eintragung im Vereinsregister.<br />
        Registergericht: Berlin<br />
        Registernummer: 1234567<br /></p><p><strong>Umsatzsteuer-ID: </strong> <br />
        Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: 222244445<br /><br />
      ...
      <p><strong>Haftungsausschluss: </strong><br /><br /><strong>Haftung für Inhalte</strong><br /><br />
        ...
        Downloads und Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebr/auch gestattet. Soweit
        die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden, werden die Urheberrechte Dritter beachtet.
        Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine
        Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden
        von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.</p><br />
    </div>
  )
}
